...
const messageService = {
    ...
    createMomoMessage(content, isHtmlMessage = false, feedback = false, feedbackData = {}) {
        return { name: '小摩AI', id: guid(), content, feedback, feedbackData, type: isHtmlMessage ? MessageTypes.Html : MessageTypes.Text, role: MessageRoles.Other, datetime: new Date() }
    },
    ...
    createEvaluationMessage(submitCallback) {
        ...
        return { name: '小摩AI', id: guid(), content: evaluation, type: MessageTypes.Html, role: MessageRoles.Other, datetime: new Date() }
    },
